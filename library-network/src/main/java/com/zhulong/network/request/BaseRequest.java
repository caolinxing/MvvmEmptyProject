...
package com.zhulong.network.request;
...
import com.zhulong.network.api.ApiService;
import com.zhulong.network.cache.RxCache;
import com.zhulong.network.cache.converter.IDiskConverter;
import com.zhulong.network.cache.model.CacheMode;
import com.zhulong.network.https.HttpsUtils;
import com.zhulong.network.interceptor.BaseDynamicInterceptor;
import com.zhulong.network.interceptor.CacheInterceptor;
import com.zhulong.network.interceptor.CacheInterceptorOffline;
import com.zhulong.network.interceptor.HeadersInterceptor;
import com.zhulong.network.interceptor.NoCacheInterceptor;
import com.zhulong.network.model.HttpHeaders;
import com.zhulong.network.model.HttpParams;
import com.zhulong.network.utils.HttpLog;
import com.zhulong.network.utils.RxUtil;
...
import static com.zhulong.network.EasyHttp.getRetrofitBuilder;
import static com.zhulong.network.EasyHttp.getRxCache;
...
public abstract class BaseRequest<R extends BaseRequest> {
    ...
    private RxCache.Builder generateRxCache() {
        ...
        switch (cacheMode) {
            ...
            default:
                final NoCacheInterceptor NOCACHEINTERCEPTOR1 = new NoCacheInterceptor();
                interceptors.add(NOCACHEINTERCEPTOR1);
                networkInterceptors.add(NOCACHEINTERCEPTOR1);
                break;
        }
