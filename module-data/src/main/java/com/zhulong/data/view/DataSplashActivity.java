 ...
 * @date: 2021/7/29
 */
public class DataSplashActivity extends BaseActivity<DataSplashAcivityLayoutBinding, BaseViewModel> {


    @Override
    public int initContentView(Bundle savedInstanceState) {
        return R.layout.data_splash_acivity_layout;
    }
    ...
    public void initData() {
        ...
        binding.btnGoCenter.setOnClickListener(v -> startContainerActivity(DataFragment.class.getCanonicalName()));
    }
